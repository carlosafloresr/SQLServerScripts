...
/****** Object:  View [dbo].[View_Expense_Reporting]    Script Date: 08/26/2008 09:06:36 ******/
SET ANSI_NULLS ON
GO
...
SELECT	GL20000.JrnEntry AS Test,
		...
		CASE WHEN PM30600.DISTREF = '' THEN CASE WHEN PM30200.TRXDSCRN  = '' THEN GL20000.DSCRIPTN ELSE PM30200.TRXDSCRN END
		...
		GL20000.SEQNUMBR,
		CASE WHEN PM30600.DISTREF = '' OR PM30600.DISTREF IS Null THEN CASE WHEN PM30200.TRXDSCRN  = '' THEN 'GL20000.DSCRIPTN' ELSE 'PM30200.TRXDSCRN' END ELSE 'PM30600.DISTREF' END AS SourceTable,
...
FROM 	GL20000 
		...
		LEFT JOIN GPCustom.dbo.Purchasing_Vouchers PV ON GL20000.OrcTrnum = PV.VoucherNumber AND LEFT(GL20000.SOURCDOC, 5) = 'PMTRX' AND PV.CompanyId = 'IMC'
...
WHERE 	GL20000.Voided = 0 AND
		...
		(LEFT(GL20000.ORTRXSRC, 5) IN ('GLTRX','GLREV')))
UNION
SELECT	GL20000.JrnEntry AS Test,
		GL00100.USRDEFS1 AS Category, 
		GL20000.ORGNTSRC,
