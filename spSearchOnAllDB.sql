...
/*                                                                       */
/*  Search for USP_SearchOnAllDB at http://aka.ms/Dev4DynGP for more info  */
/*                                                                       */
/*************************************************************************/

if exists (select * from sysobjects where id = object_id('dbo.USP_SearchOnAllDB') )
	drop procedure dbo.USP_SearchOnAllDB
GO

CREATE PROCEDURE USP_SearchOnAllDB @phrase varchar(8000), @OutFullRecords bit = 0 AS

/*
   To apply so: 
      exec  USP_SearchOnAllDB 'Sugar%'
      exec  USP_SearchOnAllDB '%soft%'
      exec  USP_SearchOnAllDB '_5234_57%', 1
      exec  USP_SearchOnAllDB M_cro_oft
*/
...
--GRANT EXECUTE ON dbo.USP_SearchOnAllDB TO DYNGRP

/* Copyright © Microsoft Corporation.  All Rights Reserved.                     */
/* This code released under the terms of the                                    */
/* Microsoft Public License (MS-PL, http://opensource.org/licenses/ms-pl.html.) */

--exec  USP_SearchOnAllDB '100XL%', 1
--exec  USP_SearchOnAllDB '%''%', 0
