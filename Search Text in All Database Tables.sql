DECLARE	@phrase			varchar(MAX) = '%JDAVIS%', 
		@OutFullRecords bit = 0

/*
   To apply so: 
      exec USP_SearchOnAllTables 'Sugar%'
      exec USP_SearchOnAllTables '%soft%'
      exec USP_SearchOnAllTables '_5234_57%', 1
      exec USP_SearchOnAllTables M_cro_oft
*/
...
--SELECT	DISTINCT 'INSERT INTO [YOUR_TABLE] VALUES (' + char(39) + TableName + char(39) + ',' + char(39) + ColumnName + char(39) + ')' AS Query
--FROM	#tbl_res2
