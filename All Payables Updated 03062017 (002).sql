...
10/10/2016  jnelson       		Modified select statement in relation to printing data for GL tables to pull journal entries posted per batch
03/06/2017	dawesh/amelroe		Modified to add Voucher Number and Document Type Entered by user running script
