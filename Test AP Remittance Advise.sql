/*
SELECT      CHK.DOCNUMBR AS CheckNumber
...
FROM	PM30200 CHK
        INNER JOIN PM30300 APL ON CHK.DOCNUMBR = APL.APFRDCNM
WHERE	CHK.DOCTYPE = 6 
        AND DOCNUMBR = 'EFS00230'

SELECT * FROM PM30200 WHERE DOCNUMBR = '9100'
SELECT * FROM PM30300 WHERE APTODCNM IN (SELECT DOCNUMBR FROM PM30200 WHERE BACHNUMB = 'DEX120105160002')
SELECT * FROM PM30600 WHERE LEFT(BACHNUMB, 3) = 'DEX' AND BACHNUMB = 'DEX120105160002'
*/
...
WHERE	CHK.DOCTYPE = 6 
        AND CHK.BACHNUMB = '120117AD01'
ORDER BY
		CHK.DOCNUMBR, APL.APTODCNM
