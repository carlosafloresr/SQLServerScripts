/*
EXECUTE USP_GP_IntercompanyReport @Period=10
*/
CREATE PROCEDURE USP_GP_IntercompanyReport
		@Period			Int
AS
SET NOCOUNT ON
...
--INSERT INTO @tblAcctAlias VALUES ('ABS','ABS', 0)
...
--INSERT INTO @tblAcctAlias VALUES ('GSA','GSA', 97)
