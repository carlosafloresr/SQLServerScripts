...
FROM 	GL20000 
	...
	LEFT JOIN GPCustom.dbo.Purchasing_Vouchers PV ON GL20000.OrcTrnum = PV.VoucherNumber AND LEFT(GL20000.SOURCDOC, 5) = 'PMTRX' AND PV.CompanyId = 'AIS'
...
WHERE 	GL20000.Voided = 0 AND
	...
	(LEFT(GL20000.ORTRXSRC, 5) IN ('GLTRX','UPRPE')))


 SELECT *
 FROM   AIS.dbo.View_Expense_Reporting View_Expense_Reporting
 WHERE  (View_Expense_Reporting.Acct2>='00' AND View_Expense_Reporting.Acct2<='99') AND (View_Expense_Reporting.EffDate>={ts '2007-11-20 00:00:00'} AND View_Expense_Reporting.EffDate<{ts '2007-12-07 00:00:00'}) AND (View_Expense_Reporting.Acct3>='5000' AND View_Expense_Reporting.Acct3<='9999') AND (View_Expense_Reporting.Acct1>='0' AND View_Expense_Reporting.Acct1<='99')
 ORDER BY View_Expense_Reporting.Acct2, View_Expense_Reporting.Category, View_Expense_Reporting.Acct3
