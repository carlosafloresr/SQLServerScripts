...
/****** Object:  LinkedServer [POSTGRESQLPROD]    Script Date: 6/16/2016 11:08:12 AM ******/
EXEC master.dbo.sp_dropserver @server=N'POSTGRESQLPROD', @droplogins='droplogins'
GO

/****** Object:  LinkedServer [POSTGRESQLPROD]    Script Date: 6/16/2016 11:08:12 AM ******/
EXEC master.dbo.sp_addlinkedserver @server = N'POSTGRESQLPROD', @srvproduct=N'PostgreSQLPROD', @provider=N'MSDASQL', @datasrc=N'PostgreSQLPROD', @location=N'devsys2.iilogistics.com', @catalog=N'dta'
